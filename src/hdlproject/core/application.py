# core/application.py
"""Application container with internal initialization"""
...
from hdlproject.utils.logging_manager import (
    setup_application_log, set_verbosity, LogLevel, get_logger, cleanup
)
...
class Application:
    ...
    def from_args(cls, args) -> 'Application':
        ...
        compile_format = (
            getattr(args, 'compile_order_format', None) or 
            repo_config.compile_order_script_format or 
            'json'
        )
    ...
    def execute_handler(self, 
                       ...
                       return_handler: bool = False) -> None:
        """
        ...
        handler = handler_info.create_handler(
            environment=self.handler_environment,
