...
class HandlerRegistry:
    ...
    def get_menu_handlers(self, for_multiple_projects: bool = False) -> list[tuple[str, HandlerInfo]]:
...
def get_menu_handlers(for_multiple_projects: bool = False) -> list[tuple[str, HandlerInfo]]:
