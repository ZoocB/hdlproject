...
class ProjectLoader:
    ...
    def load_projects(self, project_names: list[str], 
                     operation_name: str,
                     check_vivado: bool = True) -> list[ProjectContext]:
        """
        ...
        for project_name in project_names:
            try:
                context = self.load_single_project(project_name, operation_name, check_vivado)
    ...
    def load_single_project(self, project_name: str, 
                          operation_name: str = "build",
                          check_vivado: bool = True) -> ProjectContext:
        """
    ...
    def validate_projects(self, contexts: list[ProjectContext], 
                         check_vivado: bool = True) -> list[str]:
        """
